...
public class jsoncon {
	 ...
	 * @param args
	 */
	final static int n = 9;// enter number of creatives in the list
	final static int c = 5;// number of fields in the creative json

	public static JSONObject getMerchantId(JSONObject json)
			throws JSONException {

		String urlString = "http://ratnakar.api.clinknow.com/m/creative/add";
		String result = "";
	...
	public static void main(String[] args) throws JSONException {
		...
		try {
			...
			Workbook wrk1 = Workbook.getWorkbook(new File("F:/creatives.xls"));

			// Obtain the reference to the first sheet in the workbook
			Sheet sheet1 = wrk1.getSheet(0);
			WritableWorkbook copy = Workbook.createWorkbook(new File(
					"F:/creatives with ids.xls"), wrk1);
			...
			Label label2 = new Label(c, 0, "creative_id");
			...
			for (int i = 1; i < n; i++) {
				...
				orgId = (String) jsonp.get("creative_id");
